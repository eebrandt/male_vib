		...
		for trial in trials:
			...
			if os.path.isdir(trial_folder):
				...
				kwargs = dict(delimiter=",",
               				dtype= "S10, S10, S10, S10, S10, S10, f20, f20, f20, f20, f20, f20, f20, f20, f20, f20, f20, f20, f20, f20, f20, f20, f20, f20, f20, S200",
              				names= "video, complete, individual, treatment, rank, date, temperature, weight, ct_width, scrape_pos, scrape_dur, scrape_rms, thump_pos, thump_dur, thump_rms, buzz_pos, buzz_dur, buzz_rms, srate_pos, srate_dur, srate_num, buzz_freq, buzz_peak, fund_freq, fund_peak, comments",
					skip_header=1)
